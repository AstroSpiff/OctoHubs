...
- Auth DB (utenti): SQLite di default (`/mnt/shared/applications/octohubs/auth.db`).
...
- `/mnt/shared/applications/octohubs/postgres/` se Postgres e abilitato
