...
│                 FastAPI Backend                                │
│  ┌────────────────────────────────────────────────────────┐  │
│  │  ScanConnectionManager (scan_websocket_manager.py)     │  │
...
└────────────────┼──────────────────────────────────────────────┘
                 ...
                 │
┌────────────────▼──────────────────────────────────────────────┐
│         EmbyWebSocketManager (emby_websocket_manager.py)       │
...
|------|-------|-------------|
| **scan_websocket_manager.py** | 218 | ConnectionManager per client browser WebSocket |
...
| **emby_websocket_manager.py** | +75 righe | `setup_scan_progress_forwarding()` |
...
| File | Motivo |
|------|--------|
| **emby_progress_poller.py** | Completamente sostituito da WebSocket events |
