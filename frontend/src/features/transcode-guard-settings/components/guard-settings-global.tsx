  ...
  return (
    <Card className="guard-settings-global">
      <div className="guard-settings-global-copy">
        ...
        <div><h4 className="contextual-heading" title="Politica">Monitor automatico</h4><small>Reagisce agli eventi Emby; l'intervallo recupera quelli eventualmente persi.</small></div>
      </div>
      ...
      <div className="guard-settings-global-fields">
        <label><span><Clock3 size={15} aria-hidden="true" /> Intervallo verifica</span><input type="number" min="2" max="120" value={settings.poll_interval_seconds} onChange={(event) => onChange({ poll_interval_seconds: boundedWholeNumberInput(event.target.value, 2, 120) })} /><small>secondi, controllo di recupero</small></label>
