  ...
  return (
    <section className="users-selection-summary" aria-label="Azioni per utenti selezionati">
      ...
      <div className="users-selection-summary-actions">
        ...
        <Button type="button" requiresWriteAccess variant="secondary" onClick={onLink} disabled={selectedCount < 2}>
          <Link2 size={16} aria-hidden="true" />
          Associa
        </Button>
        <Button type="button" requiresWriteAccess variant="primary" onClick={onBulkSettings}>
          <SlidersHorizontal size={16} aria-hidden="true" />
          Applica impostazioni
        </Button>
        <Button type="button" requiresWriteAccess variant="primary" onClick={onBulkClone}>
